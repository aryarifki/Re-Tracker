  ...
  return (
    <main className="max-w-md mx-auto p-3 space-y-4">
      <section className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4">
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 text-center">
          ...
          <div className="bg-neutral-500/10 border border-neutral-500/20 rounded-xl py-2">
            <div className="text-neutral-300 font-bold text-lg">{counts["NETRAL"] ?? 0}</div>
      ...
      <section className="bg-neutral-900 border border-neutral-800 rounded-2xl p-3">
        <h3 className="text-sm font-semibold text-neutral-300 mb-2">🔥 Foreign Flow 5 Hari</h3>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-semibold text-neutral-300">📊 Watchlist ({items.length})</h3>
      ...
      <section className="pt-2 grid grid-cols-2 gap-2 text-center text-xs">
        <a href="/dashboard" className="bg-neutral-900 border border-neutral-800 rounded-xl py-3 text-neutral-300">
          🖥️ Dashboard Penuh
        </a>
        <a href="/broker/BBCA" className="bg-neutral-900 border border-neutral-800 rounded-xl py-3 text-neutral-300">
          🔍 Analisis BBCA
        </a>
      </section>
    </main>
